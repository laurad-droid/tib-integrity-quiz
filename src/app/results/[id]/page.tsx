    ...
    return (
      <div className="min-h-screen bg-ti-bg flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center max-w-md">
          <h1 className="text-2xl font-bold text-ti-navy mb-4">
  ...
  return (
    <div className="min-h-screen bg-ti-bg">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-ti-navy text-center mb-2">
          Your Assessment Results
        </h1>
        <p className="text-ti-gray text-center mb-12">
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-ti-navy mb-6">
            How You Compare
          </h2>
        ...
        <div className="mt-12 text-center space-x-4">
          ...
          <a
            href="/assessment"
            className="inline-block border-2 border-ti-navy text-ti-navy font-bold py-3 px-8 rounded-lg hover:bg-ti-navy hover:text-white transition-colors"
          >
